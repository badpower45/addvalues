...
const testimonials = [
  {
    ...
    quote:
      'عملت مع CodePulse على تطوير متجرنا الإلكتروني والنتيجة فاقت كل التوقعات. فريق محترف وملتزم بالمواعيد.',
    rating: 5,
    avatar: 'أ',
  },
  {
  ...
  },
  {
    ...
    quote:
      'موقعنا الجديد زاد من تفاعل العملاء بنسبة 200%. تصميم عصري وسريع جداً. شكراً CodePulse!',
    rating: 5,
    avatar: 'ل',
  },
];
